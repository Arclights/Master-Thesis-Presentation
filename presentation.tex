...
\frame{
	...
	\begin{itemize}
		\item Primitive components: komponenter som ges till assemblyn utifrån
		\item Sub-assemblies: består av primitive components och andra sub-assemblies
		\item I modellen ses båda som components $\rightarrow$ underkategorier
		\item man markerar den task en sub-assembly blir skapad
	\end{itemize}
...
\frame{
	...
	\end{adjustwidth}
		\note{
			Undvika kollision:
			\begin{itemize}
				\item Individuella tasks får inte överlappa på fixtures, trays eller outputs  
...
\frame{
	...
	\note{
	\begin{itemize}
		\item För att veta när en tool change uppstår
		\item Antar att det finns en uppsättning av sagda tools för varje maskin
	\end{itemize}
	}
}
...
\frame{
	...
	\begin{adjustwidth}{-0.5cm}{}
		...
		\note{
		\begin{itemize}
			\item Notera att "Lift top-button" inte har tool specificerad $\rightarrow$ ger mer frihet med tool changes
		\end{itemize}
...
\frame{
	...
	\note{
		\begin{itemize}
			\item Vi kan inte sätta upp constraint om ordning baserat på att tasks är move. 
			\item T.ex. kan flera move hantera tasks med samma komponent (ex. highlight:ade) $\rightarrow$ kan inte säga något om ordningen.
			\item Så för att bl.a. lösa det: $\downarrow$ 
		\end{itemize}
...
\frame{
	...
	\begin{adjustwidth}{-0.5cm}{}
		...
		\note{
			\begin{itemize}
				\item Array med tasks
				\item Sätter upp predecessors
			\end{itemize}
		}
}
...
\frame{
	...
	\begin{adjustwidth}{-0.5cm}{}
		...
		\note{
			\begin{itemize}
				\item Representera en task med flera maskiner
				\item En task med flera maskiner vs flera concurrent tasks
				\item En task med flera maskiner $\rightarrow$ tasks måste kunna ha flera predecessors $\rightarrow$ fungerar inte här
			\end{itemize}
		}
}
...
\frame{
	\frametitle{Solvers Tested}
		\begin{itemize}
			...
			\item Choco3
		\end{itemize}
		\note{OM MINDRE ÄN 10 MINUTER KVAR, HOPPA SOLVERINTRODUKTIONER}
}
